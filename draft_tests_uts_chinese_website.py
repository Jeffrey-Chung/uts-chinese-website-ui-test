...
def ui_test(driver):
        try:
                ...
                contact_form_button = driver.find_element(By.XPATH, '/html/body/div[5]/div[2]/main/div/article/div/div/div[1]/div/div/div[2]/a[1]').click()
                 
                #Fills in the details of the contact form, each variable represents each field
                name = driver.find_element(By.XPATH, '/html/body/div[5]/div[2]/main/div/article/div/div/div[1]/div[1]/div/form/div[2]/div[1]/span/input').send_keys("Jane Smith")
